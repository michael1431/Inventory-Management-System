...
if(!isset($_SESSION['userid'])){
    ...
    $mng = new Manage();
    $id = $_SESSION['userid']; // id of individual user
    $getUserData = $mng->userData($id);
    
    if(isset($_POST['updt_profile'])){
     $uName = $_POST['uName'];   
     $updateUser = $mng->userUpdate($uName,$id); /// belong to the user class
                             ...
                             <div class="card-body">
                                 ...
                                 <form autocomplete="off" action="" method="post">                                         
                                      ...
                                      ?>
                                         <div class="form-group row">                                             
                                             ...
                                             <div class="col-sm-6">
                                                 <input type="text" id="uName" name="uName" class="form-control form-control-sm" value="<?php echo $result['username'];?>"/>
                                             </div>
                                         </div>
                                     <div class="form-group row">
                                         <label class="col-sm-3"></label>                                         
                                         <div class="col-sm-6">
                                             <input type="submit" name="updt_profile" class="btn btn-success btn-sm" value="Save Changes"/>
                                         </div>
                                     </div>
                                      <?php }}?>
                                        <br><br>
                               ...
                               <!----  next execution begin --->
                                ...
                                if($userPassword==$old_password){
                                    ...
                                    $updatedPass .= $mng->changePassword($id,$new_password); // belong to the AdminLogin class        
                                    }else{
                                    $updatedPass .= "<span style='color:red;font-weight:bold'>Your New & Confirm password not match</span>";
                                    }        
                                    }else{
                             ...
                             ?>  
                                 ...
                                 <form autocomplete="off" action="" method="post">
                                       ...
                                       <div class="form-group row">
                                         <label class="col-sm-3"></label>                                         
                                         <div class="col-sm-6">
                                             <input type="submit" name="save" class="btn btn-primary btn-sm" value="Save Changes"/>
                                         </div>
                                       </div>
                                 </form>
                             </div>
